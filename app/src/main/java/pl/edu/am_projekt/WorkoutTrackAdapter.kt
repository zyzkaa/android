...
//        }
    ...
    fun addData(newExercise: Exercise){
        val newEmptyExercise = ExerciseWithTrackData(newExercise, mutableListOf(InputData(0.0, 0)))
        if(checkExerecisesContains(newExercise)) return
    ...
    fun getExercises() : List<ExerciseWithTrackData>{
        return exercises
    }
